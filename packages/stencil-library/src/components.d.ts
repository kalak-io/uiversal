...
export namespace Components {
  ...
  interface UvCheckbox {
    /**
     * (optional) Whether the command or control is checked
     */
    checked?: boolean;
    /**
...
declare global {
  ...
  interface HTMLUvCheckboxElement extends Components.UvCheckbox, HTMLStencilElement {
    addEventListener<K extends keyof HTMLUvCheckboxElementEventMap>(
      type: K,
      listener: (this: HTMLUvCheckboxElement, ev: UvCheckboxCustomEvent<HTMLUvCheckboxElementEventMap[K]>) => any,
    ...
    removeEventListener<K extends keyof HTMLUvCheckboxElementEventMap>(
      type: K,
      listener: (this: HTMLUvCheckboxElement, ev: UvCheckboxCustomEvent<HTMLUvCheckboxElementEventMap[K]>) => any,
  ...
  interface HTMLUvInputElement extends Components.UvInput, HTMLStencilElement {
    addEventListener<K extends keyof HTMLUvInputElementEventMap>(
      type: K,
      listener: (this: HTMLUvInputElement, ev: UvInputCustomEvent<HTMLUvInputElementEventMap[K]>) => any,
      options?: boolean | AddEventListenerOptions,
    ): void;
    addEventListener<K extends keyof DocumentEventMap>(type: K, listener: (this: Document, ev: DocumentEventMap[K]) => any, options?: boolean | AddEventListenerOptions): void;
    addEventListener<K extends keyof HTMLElementEventMap>(
    ...
    addEventListener(type: string, listener: EventListenerOrEventListenerObject, options?: boolean | AddEventListenerOptions): void;
    removeEventListener<K extends keyof HTMLUvInputElementEventMap>(
      type: K,
      listener: (this: HTMLUvInputElement, ev: UvInputCustomEvent<HTMLUvInputElementEventMap[K]>) => any,
      options?: boolean | EventListenerOptions,
    ): void;
